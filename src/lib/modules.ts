...
export const modules = {
  ...
  drivers: {
    ...
    columns: ["full_name", "driver_code", "phone", "licence_number", "licence_expiry", "assigned_vehicle_id", "status"],
    statusKey: "status",
    ...
    fields: [
      ...
      { key: "assigned_vehicle_id", label: "Assigned truck", type: "ref", refTable: "vehicles", refFilter: { key: "is_trailer", value: false } },
      { key: "assigned_trailer_id", label: "Assigned trailer", type: "ref", refTable: "vehicles", refFilter: { key: "is_trailer", value: true } },
  ...
  loads: {
    ...
    columns: ["load_reference", "direction", "booking_number", "job_number", "customer_id", "trip_id", "cargo_category", "expected_quantity", "status"],
    statusKey: "status",
    searchKeys: ["load_reference", "booking_number", "job_number", "cargo_description", "seal_number"],
    fields: [
      ...
      { key: "cargo_description", label: "Cargo description" },
      {
        ...
        label: "Cargo type",
        type: "select",
        options: ["Sulphur", "Copper", "Other"],
      },
      { key: "expected_quantity", label: "Expected quantity", type: "number" },
      { key: "unit_of_measure", label: "Unit" },
      { key: "expected_weight", label: "Expected weight (kg)", type: "number" },
      { key: "origin" },
      { key: "destination" },
      { key: "planned_loading_date", type: "date" },
      { key: "seal_number", label: "Expected seal number" },
      {
        key: "status",
        type: "select",
        readOnly: true,
  ...
  fuel_transactions: {
    ...
    fields: [
      ...
      { key: "trip_id", label: "Trip", type: "ref", refTable: "trips" },
      {
        ...
        refTable: "vehicles",
        refFilter: { key: "is_trailer", value: false },
        refRule: { by: "trip_id", resolve: "trucksByTrip" },
      },
      {
        key: "driver_id",
        label: "Driver",
      ...
      { key: "price_per_litre", label: "Price per litre", type: "number" },
      { key: "total_cost", label: "Total cost", type: "number" },
      { key: "currency", type: "select", options: ["TZS", "USD"] },
      { key: "location" },
      { key: "country" },
      { key: "supplier" },
      {
