...
export const nav: NavGroup[] = [
  {
    ...
    items: [
      ...
      { label: "Vehicles", icon: "Truck", to: "/m/vehicles", module: "vehicles" },
      { label: "Drivers", icon: "IdCard", to: "/m/drivers", module: "drivers" },
      ...
      { label: "Technicians", icon: "HardHat", to: "/m/technicians", module: "technicians" },
